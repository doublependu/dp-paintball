...
# Gameplay
 ...
 4. There should be two cross hairs
...
# Map
 ...
 1. I'd like to have a bigger map. I'll provide some ref images of Central Park New York for you to work with. 
 2. Beyond the core play area of the map, there should be a procedurually generated forest beyond that. players can actually wonder into it if they choose to. 
 3. Beyond that, there should be city lines of New York city around the park. 
